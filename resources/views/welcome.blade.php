    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 text-decoration-none">Home</a>
                    <a href="{{ url('group') }}" class="text-sm text-gray-700 dark:text-gray-500 text-decoration-none">Create Gruop</a>
                    <a href="{{ url('keyword') }}" class="text-sm text-gray-700 dark:text-gray-500 text-decoration-none">Create Keywords</a>
                    <a href="{{ url('viewprofile') }}" class="text-sm text-gray-700 dark:text-gray-500 text-decoration-none">My Profile</a>
                    <a href="{{ url('list_group') }}" class="text-sm text-gray-700 dark:text-gray-500 text-decoration-none">Group List</a>
